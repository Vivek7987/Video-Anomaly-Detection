...
def send_alert(email, message):
    ...
    sender_email = "paljivivek12@gmail.com"
    sender_password = "zwdb oagm gdsq omjl"  # App password without spaces
...
#     sender_password = "xlozfanafcyumfhj"  # Replace with your Gmail app password
